...
require (
	...
	github.com/cloud-native-toolkit/atkmod v0.1.1
	github.com/cloud-native-toolkit/itzcli/api v1.0.0
...
replace github.com/cloud-native-toolkit/itzcli/api v1.0.0 => ./api
