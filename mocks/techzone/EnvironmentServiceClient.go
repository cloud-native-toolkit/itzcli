...
type mockConstructorTestingTNewEnvironmentServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewEnvironmentServiceClient(t mockConstructorTestingTNewEnvironmentServiceClient) *EnvironmentServiceClient {
